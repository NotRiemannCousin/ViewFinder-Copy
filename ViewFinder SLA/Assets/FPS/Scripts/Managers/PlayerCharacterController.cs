...
namespace ViewFinder.Managers
{
    ...
    public class PlayerCharacterController : MonoBehaviour
    {
        ...
        PlayerItemsManager m_WeaponsManager;
        ...
        void Start()
        {
            ...
            m_WeaponsManager = GetComponent<PlayerItemsManager>();
            DebugUtility.HandleErrorIfNullGetComponent<PlayerItemsManager, PlayerCharacterController>(
